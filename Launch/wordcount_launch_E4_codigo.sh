...
do
    ...
    do
        ...
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/$USER/wc.jar org.apache.hadoop.examples.WordCount_E4 $INPUT $OUTPUT/E4/IT_$ITERATION/$(printf %03d $PERCENT) ${TRADUCCIO_PERCENT[$PERCENT]}
    done
done
