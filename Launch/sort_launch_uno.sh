...
do
    ...
    do
        ...
        ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E1/IT_$ITERATION/"
        while ! (rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E1/IT_$ITERATION/E1_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E1/IT_$ITERATION/E1_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3
        ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E2/IT_$ITERATION/"
        while ! (rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E2/IT_$ITERATION/E2_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E2/IT_$ITERATION/E2_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3
        ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E3/IT_$ITERATION/"
        while ! (rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E3/IT_$ITERATION/E3_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E3/IT_$ITERATION/E3_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
