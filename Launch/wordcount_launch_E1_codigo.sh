...
do
    ...
    do
        ...
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/$USER/wc.jar org.apache.hadoop.examples.WordCount_E1 $INPUT $OUTPUT/E1/IT_$ITERATION/$(printf %03d $PERCENT) 2 $PERCENT
    done
done
