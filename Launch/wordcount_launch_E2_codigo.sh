...
do
    ...
    do
        ...
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/$USER/wc.jar org.apache.hadoop.examples.WordCount_E2 $INPUT $OUTPUT/E2/IT_$ITERATION/$(printf %03d $PERCENT) 2 ${TRADUCCIO_PERCENT[$PERCENT]}
    done
done
