...
System.out.println("totalbutestowrite  " +totalBytesToWrite);

System.out.println("numBytesToWritePerMap " +numBytesToWritePerMap);

System.out.println("numMapsPerHost " +numMapsPerHost);
System.out.println("numBytesToWritePerMap " +numBytesToWritePerMap);
System.out.println("cluster.getTaskTrackers " +cluster.getTaskTrackers());
  ...
  public static void main(String[] args) throws Exception {
	System.out.println("MAIN SOOOORT RNDOMTEXT");
