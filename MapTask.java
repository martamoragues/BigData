    ...
    try {
	  ...
	  if(estrategia == 1)
	  {
		Random rnd = new Random(2);
      	...
      	System.out.println("MARTA RANDOM: " + random);
	    
		if(random <= 50){
        	System.out.println("MARTA entra al if");
	  ...
	  System.out.println("MARTA CLASS " + ((org.apache.hadoop.mapreduce.lib.input.FileSplit)split).getStart());
     System.out.println("MARTA CLASS " + split.getClass());
     System.out.println("MARTA CLASS " + split.getClass().getName());
		long size_all_data = 307200;
		Float skipModule = 0.5f;
      ...
      else if(estrategia == 5)
	 {
        ...
        int skipModule = 2;
        long size_block = ((org.apache.hadoop.mapreduce.lib.input.FileSplit)split).getLength();
        long num_bloc = start_block / size_block;
        boolean result = ((num_bloc%skipModule)==0);
		if(result){
			System.out.println("MARTA IF E5: ");
			mapper.run(mapperContext);
		} 
	}	
      input.close();
