...
do
    ...
    do
        ...
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/martam/hadoop-0.20.203.0/hadoop-examples-0.20.203.0.jar sort -D sampling.seed=2 -D sampling.estrategia=1 -D sampling.P=$PERCENT \
			$COMPRESS_OPT \
            -outKey org.apache.hadoop.io.Text \
            -outValue org.apache.hadoop.io.Text \
            -r ${NUM_REDS} \
			  $INPUT $OUTPUT/E1/IT_$ITERATION/$(printf %03d $PERCENT)
        ...
        while ! (ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3 ; ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E1/IT_$ITERATION/" ; rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E1/IT_$ITERATION/E1_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E1/IT_$ITERATION/E1_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        echo "Executing iteration $ITERATION with percent $PERCENT"
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/martam/hadoop-0.20.203.0/hadoop-examples-0.20.203.0.jar sort -D sampling.seed=2 -D sampling.estrategia=2 -D sampling.P=${TRADUCCIO_PERCENT[$PERCENT]} \
			$COMPRESS_OPT \
            -outKey org.apache.hadoop.io.Text \
            -outValue org.apache.hadoop.io.Text \
            -r ${NUM_REDS} \
			$INPUT $OUTPUT/E2/IT_$ITERATION/$(printf %03d $PERCENT)
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        while ! (ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3 ; ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E2/IT_$ITERATION/" ; rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E2/IT_$ITERATION/E2_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E2/IT_$ITERATION/E2_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        echo "Executing iteration $ITERATION with percent $PERCENT"
        ${HADOOP_HOME}/bin/hadoop --config $CONF jar /scratch/nas/2/martam/hadoop-0.20.203.0/hadoop-examples-0.20.203.0.jar sort -D sampling.all.file.size=3638119237 -D sampling.estrategia=3 -D sampling.P=${TRADUCCIO_PERCENT[$PERCENT]} \
			$COMPRESS_OPT \
            -outKey org.apache.hadoop.io.Text \
            -outValue org.apache.hadoop.io.Text \
            -r ${NUM_REDS} \
			$INPUT $OUTPUT/E3/IT_$ITERATION/$(printf %03d $PERCENT)
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        while ! (ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3 ; ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E3/IT_$ITERATION/" ; rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E3/IT_$ITERATION/E3_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E3/IT_$ITERATION/E3_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        while ! (ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3 ; ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E4/IT_$ITERATION/" ; rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E4/IT_$ITERATION/E4_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E4/IT_$ITERATION/E4_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
...
do
    ...
    do
        ...
        echo "Copying form local hd of iteration $ITERATION with percent $PERCENT to remote pc"
        while ! (ssh -N -f -L 12025:127.0.0.1:12024 -i /scratch/nas/2/martam/ssh/id_dsa martam@172.18.3.3 ; ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa jcugat@127.0.0.1 "mkdir -p /media/jcugat/marta/core/sort/E5/IT_$ITERATION/" ; rsync --partial -az -e "ssh -p 12025 -oStrictHostKeyChecking=no -i /scratch/nas/2/martam/ssh/id_dsa" $LOCAL_HD/E5/IT_$ITERATION/E5_$(printf %03d $PERCENT).txt jcugat@127.0.0.1:/media/jcugat/marta/core/sort/E5/IT_$ITERATION/E5_$(printf %03d $PERCENT).txt) ; do sleep 1 ; done
