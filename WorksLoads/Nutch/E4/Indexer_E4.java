...
public class Indexer_E4 extends Configured implements Tool {

  public static final String DONE_NAME = "index.done";

  public static final Log LOG = LogFactory.getLog(Indexer_E4.class);

  public Indexer_E4() {
    super(null);
  }

  public Indexer_E4(Configuration conf) {
    super(conf);
  }
  ...
  throws IOException {
    ...
    LOG.info("Indexer_E4: starting at " + sdf.format(start));
    ...
    LOG.info("Indexer_E4: finished at " + sdf.format(end) + ", elapsed: " + TimingUtil.elapsedTime(start, end));
  }

  public int run(String[] args) throws Exception {
    if (args.length < 6) {
      System.err.println("Usage: Indexer_E4 <index> <crawldb> <linkdb> <segment> ...");
      return -1;
    }
    ...
    try {
      ...
      LOG.fatal("Indexer_E4: " + StringUtils.stringifyException(e));
      return -1;
    }
  }

  public static void main(String[] args) throws Exception {
    final int res = ToolRunner.run(NutchConfiguration.create(), new Indexer_E4(), args);
    System.exit(res);
  }
}
