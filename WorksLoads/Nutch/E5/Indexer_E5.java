...
public class Indexer_E5 extends Configured implements Tool {

  public static final String DONE_NAME = "index.done";

  public static final Log LOG = LogFactory.getLog(Indexer_E5.class);

  public Indexer_E5() {
    super(null);
  }

  public Indexer_E5(Configuration conf) {
    super(conf);
  }
  ...
  throws IOException {
    ...
    LOG.info("Indexer_E5: starting at " + sdf.format(start));
    ...
    LOG.info("Indexer_E5: finished at " + sdf.format(end) + ", elapsed: " + TimingUtil.elapsedTime(start, end));
  }

  public int run(String[] args) throws Exception {
    if (args.length < 6) {
      System.err.println("Usage: Indexer_E5 <index> <crawldb> <linkdb> <segment> ...");
      return -1;
    }
    ...
    try {
      ...
      LOG.fatal("Indexer_E5: " + StringUtils.stringifyException(e));
      return -1;
    }
  }

  public static void main(String[] args) throws Exception {
    final int res = ToolRunner.run(NutchConfiguration.create(), new Indexer_E5(), args);
    System.exit(res);
  }
}
