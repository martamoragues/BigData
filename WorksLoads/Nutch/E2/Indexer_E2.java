...
public class Indexer_E2 extends Configured implements Tool {

  public static final String DONE_NAME = "index.done";

  public static final Log LOG = LogFactory.getLog(Indexer_E2.class);

  public Indexer_E2() {
    super(null);
  }

  public Indexer_E2(Configuration conf) {
    super(conf);
  }
  ...
  throws IOException {
    ...
    LOG.info("Indexer_E2: starting at " + sdf.format(start));
    ...
    LOG.info("Indexer_E2: finished at " + sdf.format(end) + ", elapsed: " + TimingUtil.elapsedTime(start, end));
  }

  public int run(String[] args) throws Exception {
    if (args.length < 6) {
      System.err.println("Usage: Indexer_E2 <index> <crawldb> <linkdb> <segment> ...");
      return -1;
    }
    ...
    try {
      ...
      LOG.fatal("Indexer_E2: " + StringUtils.stringifyException(e));
      return -1;
    }
  }

  public static void main(String[] args) throws Exception {
    final int res = ToolRunner.run(NutchConfiguration.create(), new Indexer_E2(), args);
    System.exit(res);
  }
}
