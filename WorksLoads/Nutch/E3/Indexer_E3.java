...
public class Indexer_E3 extends Configured implements Tool {

  public static final String DONE_NAME = "index.done";

  public static final Log LOG = LogFactory.getLog(Indexer_E3.class);

  public Indexer_E3() {
    super(null);
  }

  public Indexer_E3(Configuration conf) {
    super(conf);
  }
  ...
  throws IOException {
    ...
    LOG.info("Indexer_E3: starting at " + sdf.format(start));
    ...
    LOG.info("Indexer_E3: finished at " + sdf.format(end) + ", elapsed: " + TimingUtil.elapsedTime(start, end));
  }

  public int run(String[] args) throws Exception {
    if (args.length < 6) {
      System.err.println("Usage: Indexer_E3 <index> <crawldb> <linkdb> <segment> ...");
      return -1;
    }
    ...
    try {
      ...
      LOG.fatal("Indexer_E3: " + StringUtils.stringifyException(e));
      return -1;
    }
  }

  public static void main(String[] args) throws Exception {
    final int res = ToolRunner.run(NutchConfiguration.create(), new Indexer_E3(), args);
    System.exit(res);
  }
}
