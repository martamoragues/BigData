 ...
 */
public class Sort_E5<K,V> extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    JobConf jobConf = new JobConf(getConf(), Sort_E5.class);
    //jobConf.setJobName("sort E5 P: " +P);
...
System.out.println("getNumMapTasks()  " + jobConf.getNumMapTasks() );
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new Sort_E5(), args);
    System.exit(res);
  }
