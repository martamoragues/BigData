 ...
 */
public class Sort_E1<K,V> extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    JobConf jobConf = new JobConf(getConf(), Sort_E1.class);
    //jobConf.setJobName("sort E1 seed: "+seed+ " P: " +P);
	jobConf.setMapperClass(IdentityMapper_E1.class);
...
System.out.println("getNumMapTasks()  " + jobConf.getNumMapTasks() );
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new Sort_E1(), args);
    System.exit(res);
  }
