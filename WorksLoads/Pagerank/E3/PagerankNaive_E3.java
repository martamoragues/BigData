...
//System.out.println("current read: " + current_read);			
    ...
    {
		final int result = ToolRunner.run(new Configuration(), new PagerankNaive_E3(), args);
    ...
    {
		System.out.println("PagerankNaive_E3 <input_path> <output_path> <# of nodes>  <# of tasks> <max iteration> <makesym or nosym> <new or contNN>");
    ...
    {
		final JobConf conf = new JobConf(getConf(), PagerankNaive_E3.class);
