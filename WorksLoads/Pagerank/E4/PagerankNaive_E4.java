...
public class PagerankNaive_E4 extends Configured implements Tool 
{
...
//System.out.println("current read: " + current_read);			
	...
	public static MinMaxInfo_E4 readMinMax(String new_path) throws Exception
	{
		MinMaxInfo_E4 info = new MinMaxInfo_E4();
    ...
    protected JobConf configStage1 () throws Exception
    {
		...
		conf.set("P", "" + P);
		conf.setJobName("Pagerank_Stage1_E4 "+"P:" + P);
