...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/100 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 100"
fi

if [ $BLOCK -eq 0 ]
then
    $HADOOP_HOME/bin/hadoop --config $CONF jar $HIBENCH_HOME/pagerank/pegasus-2.0.jar pegasus.PagerankNaive_E2 $OPTION
fi

if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/50 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 50"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/25 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 25"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/10 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 10"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/5 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 5"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E2/IT_1/1 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1 1"
fi
