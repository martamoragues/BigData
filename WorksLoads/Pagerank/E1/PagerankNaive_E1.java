...
public class PagerankNaive_E1 extends Configured implements Tool 
{
	...
	public static MinMaxInfo_E1 readMinMax(String new_path) throws Exception
	{
		MinMaxInfo_E1 info = new MinMaxInfo_E1();
    ...
    protected JobConf configStage1 () throws Exception
    {
		...
		conf.set("P", "" + P);
		conf.setJobName("Pagerank_Stage1_E1" +" seed_console" + seed_console+" P" + P);
