...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/100 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 1"
fi

if [ $BLOCK -eq 0 ]
then
    $HADOOP_HOME/bin/hadoop --config $CONF jar $HIBENCH_HOME/pagerank/pegasus-2.0.jar pegasus.PagerankNaive_E5 $OPTION
fi

if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/50 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 0.5"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/25 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 0.25"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/10 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 0.1"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/5 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 0.05"
fi
...
if [ $BLOCK -eq 0 ]
then
    OPTION="${COMPRESS_OPT} ${INPUT_HDFS}/edges ${OUTPUT_HDFS}/E5/IT_1/1 ${PAGES} ${NUM_REDS} ${NUM_ITERATIONS} nosym new 0.01"
fi
