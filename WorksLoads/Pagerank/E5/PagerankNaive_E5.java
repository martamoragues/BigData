...
public class PagerankNaive_E5 extends Configured implements Tool 
{
    ...
    {
		final int result = ToolRunner.run(new Configuration(), new PagerankNaive_E5(), args);
    ...
    {
		System.out.println("PagerankNaive_E5 <input_path> <output_path> <# of nodes>  <# of tasks> <max iteration> <makesym or nosym> <new or contNN>");
	...
	public static MinMaxInfo_E5 readMinMax(String new_path) throws Exception
	{
		MinMaxInfo_E5 info = new MinMaxInfo_E5();
    ...
    {
		final JobConf conf = new JobConf(getConf(), PagerankNaive_E5.class);
		conf.set("number_nodes", "" + number_nodes);
		conf.set("mixing_c", "" + mixing_c);
		conf.set("make_symmetric", "" + make_symmetric);
		conf.set("P", "" + P);
		conf.setJobName("Pagerank_Stage1_E5 P:" + P);
